...
module.exports = ({ config }) => {
  ...
  return {
    ...config,
    ...overrides,
    ios: { ...config.ios, ...overrides.ios, bundleIdentifier: "com.arutech.marketplace.customer" },
    android: { ...config.android, ...overrides.android, package: "com.arutech.marketplace.customer" },
